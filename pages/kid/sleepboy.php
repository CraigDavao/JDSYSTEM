...
// Fixed filters: Kid → Boys → Sleepwear & Underwear
$categoryGroup = 'kid';
$gender        = 'boys';
...
<head>
  <meta charset="utf-8">
  <title>Kid — Boys Sleepwear & Underwear</title>
...
<body>
  <div class="new-header">
    <h1 class="new-title">Boys Sleepwear & Underwear</h1>
  </div>
  ...
  <div class="product-grid">
    ...
    <?php endwhile; else: ?>
      <p style="grid-column:1/-1; opacity:.7;">No boys sleepwear or underwear found.</p>
    <?php endif; ?>
  </div>
  ...
  <?php if ($totalPages > 1): ?>
    <div class="pager">
      <?php for ($i=1; $i <= $totalPages; $i++): ?>
        ...
        <?php else: ?>
          <a href="<?= SITE_URL ?>pages/sleepboy.php?page=<?= $i ?>"><?= $i ?></a>
        <?php endif; ?>
      <?php endfor; ?>
    </div>
  <?php endif; ?>
