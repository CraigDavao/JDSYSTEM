...
$gender        = 'unisex';
$subcategory   = 'toys-gifts'; // <-- change for this page
...
<?php endwhile; else: ?>
    <p style="grid-column:1/-1; opacity:.7;">No toys or gifts found.</p>
<?php endif; ?>
</div>
...
<div class="pager">
    <?php for ($i = 1; $i <= $totalPages; $i++): ?>
        ...
        <?php else: ?>
            <a href="<?= SITE_URL ?>pages/accessories/toys.php?page=<?= $i ?>"><?= $i ?></a>
        <?php endif; ?>
    <?php endfor; ?>
</div>
<?php endif; ?>
