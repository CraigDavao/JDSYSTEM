...
$allowedSub = ['bags-hats', 'hair-accessories', 'socks-tights', 'bow-ties', 'toys-gifts', 'other-accessories'];
$subcategory = $_GET['subcategory'] ?? 'toys-gifts';
...
<body>
  ...
  <div class="product-grid">
    <?php if ($products->num_rows): ?>
      ...
      <?php endwhile; ?>
    <?php else: ?>
      <p style="grid-column:1/-1;opacity:.7;">No <?= str_replace('-', ' or ', $subcategory) ?> found.</p>
    <?php endif; ?>
  </div>
